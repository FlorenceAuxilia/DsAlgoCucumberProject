...
@array
Scenario: Validate Array Python Editor is working -valid scenario
...
@array
Scenario: Validate Array Python Editor is working -invalid scenario
    Given The user is on the Python Editor
    When The user enter invalid python code "hello world!" and clicks run button
    Then User should see the error message

@array
Scenario: Validate Array Practice Questions is working1 
...
@array
Scenario: Validate Array Practice Questions is working2 
...
@array
Scenario: Validate Array Practice Questions is working5 
    Given The use is on the  Array Practice Questions Page
